...
object AdWordsUserInterests {
  ...
  val verticals = Map(
  	...
  	"Record Labels" -> "1114",
  	"Events & Listings" -> "569",
  	"Bars, Clubs & Nightlife" -> "188",
  	"Concerts & Music Festivals" -> "891",
  	"Event Ticket Sales" -> "614",
  	"Expos & Conventions" -> "1531",
  	"Film Festivals" -> "1086",
  	"Food & Beverage Events" -> "1530",
  	...
  	"TV Comedies" -> "1047",
  	"TV Documentary & Nonfiction" -> "1411",
  	"TV Dramas" -> "1193",
  	...
  	"TV Talent & Variety Shows" -> "1410",
  	"TV Talk Shows" -> "1048",
  	"Visual Art & Design" -> "24",
  	"Architecture" -> "477",
  	"Art & Craft Supplies" -> "1361",
  	"Art Museums & Galleries" -> "1521",
  	"Arts Education" -> "1195",
  	"Design" -> "653",
  	"Graphic Design" -> "654",
  	...
  	"BMX Bikes" -> "1402",
  	"Bike Accessories" -> "1398",
  	"Bike Frames" -> "1399",
  	"Bike Helmets & Protective Gear" -> "1400",
  	"Bike Parts & Repair" -> "1401",
  	"Cruiser Bikes" -> "1403",
  	"Cycling Apparel" -> "1407",
  	"Kid's Bikes" -> "1404",
  	"Mountain Bikes" -> "1405",
  	"Road Bikes" -> "1406",
  	...
  	"Vehicle & Traffic Safety" -> "1416",
  	"Vehicle Licensing & Registration" -> "170",
  	"Driving Instruction & Driver Education" -> "1415",
  	...
  	"Fitness" -> "94",
  	"Bodybuilding" -> "241",
  	"Fitness Equipment & Accessories" -> "1417",
  	"Fitness Instruction & Personal Training" -> "1418",
  	"Gyms & Health Clubs" -> "1419",
  	"Yoga & Pilates" -> "611",
  	"Hair Care" -> "146",
  	"Hair Loss" -> "235",
  	...
  	"Brand Management" -> "1548",
  	"Marketing" -> "83",
  	"Promotional Items & Corporate Gifts" -> "1420",
  	...
  	"Trade Fairs & Industry Shows" -> "335",
  	...
  	"BlackBerry OS" -> "1535",
  	"Symbian OS" -> "1536",
  	"Windows Mobile OS" -> "1537",
  	"Windows OS" -> "737",
  	"Software Utilities" -> "224",
  	"Finance" -> "7",
  	"Accounting & Auditing" -> "278",
  	"Billing & Invoicing" -> "1427",
  	"Bookkeeping" -> "1428",
  	"Tax Preparation & Planning" -> "1283",
  	"Banking" -> "37",
  	"ATMs & Branch Locations" -> "1429",
  	"Debit & Checking Services" -> "1430",
  	"Money Transfer & Wire Services" -> "1432",
  	"Savings Accounts" -> "1431",
  	"Credit & Lending" -> "279",
  	"Credit Cards" -> "811",
  	"Credit Reporting & Monitoring" -> "1433",
  	"Debt Collection & Repossession" -> "1434",
  	"Debt Management" -> "812",
  	"Loans" -> "1435",
  	"Home Financing" -> "466",
  	"Home Equity Loans & Lines of Credit" -> "1445",
  	"Home Refinancing" -> "1446",
  	"Mortgages" -> "1447",
  	"Personal Loans" -> "1436",
  	"Short-Term Loans & Cash Advances" -> "1437",
  	"Student Loans & College Financing" -> "813",
  	"Vehicle Financing" -> "1448",
  	"Auto Financing" -> "468",
  	"Financial Planning & Management" -> "903",
  	"Asset & Portfolio Management" -> "1439",
  	"Inheritance & Estate Planning" -> "1438",
  	"Retirement & Pension" -> "619",
  	"Grants, Scholarships & Financial Aid" -> "1282",
  	"Government Grants" -> "1440",
  	"Study Grants & Scholarships" -> "1441",
  	"Insurance" -> "38",
  	"Health Insurance" -> "249",
  	"Home Insurance" -> "465",
  	"Life Insurance" -> "1442",
  	"Travel Insurance" -> "1443",
  	"Vehicle Insurance" -> "1444",
  	"Auto Insurance" -> "467",
  	"Investing" -> "107",
  	"Brokerages & Day Trading" -> "1449",
  	"Commodities & Futures Trading" -> "904",
  	"Currencies & Foreign Exchange" -> "814",
  	"Derivatives" -> "1450",
  	"Funds" -> "1451",
  	"Exchange Traded Funds" -> "1452",
  	"Hedge Funds" -> "1453",
  	"Mutual Funds" -> "1454",
  	"Real Estate Investment Trusts" -> "1455",
  	"Socially Responsible Investing" -> "1456",
  	"Stocks & Bonds" -> "1457",
  	"Bonds" -> "1458",
  	"Exchanges" -> "1459",
  	"Food & Drink" -> "71",
  	...
  	"BBQ & Grilling" -> "1525",
  	"Cuisines" -> "911",
  	"East Asian Cuisine" -> "912",
  	"Chinese Cuisine" -> "1551",
  	"Japanese Cuisine" -> "1552",
  	"Korean Cuisine" -> "1554",
  	"Eastern European Cuisine" -> "1563",
  	"French Cuisine" -> "1556",
  	"German Cuisine" -> "1564",
  	"Latin American Cuisine" -> "913",
  	"Caribbean Cuisine" -> "1566",
  	"Mexican Cuisine" -> "1560",
  	"South American Cuisine" -> "1565",
  	"Mediterranean Cuisine" -> "914",
  	"Greek Cuisine" -> "1558",
  	"Italian Cuisine" -> "1557",
  	"Spanish Cuisine" -> "1559",
  	"Middle Eastern Cuisine" -> "1532",
  	"North American Cuisine" -> "915",
  	"South Asian Cuisine" -> "1567",
  	"Indian Cuisine" -> "1553",
  	"Southeast Asian Cuisine" -> "1568",
  	"Thai Cuisine" -> "1555",
  	"Vietnamese Cuisine" -> "1569",
  	...
  	"Food" -> "1512",
  	"Baked Goods" -> "907",
  	"Breakfast Foods" -> "1513",
  	"Candy & Sweets" -> "906",
  	"Condiments & Dressings" -> "1538",
  	"Cooking Fats & Oils" -> "1539",
  	"Dairy & Eggs" -> "1514",
  	"Cheese" -> "1540",
  	"Fruits & Vegetables" -> "908",
  	"Gourmet & Specialty Foods" -> "1541",
  	"Grains & Pasta" -> "1515",
  	"Herbs & Spices" -> "1516",
  	"Jams, Jellies & Preserves" -> "1542",
  	"Meat & Seafood" -> "909",
  	"Beef" -> "1543",
  	"Fish & Seafood" -> "1544",
  	"Pork" -> "1545",
  	"Poultry" -> "1546",
  	"Organic & Natural Foods" -> "1517",
  	"Snack Foods" -> "1518",
  	"Food & Grocery Delivery" -> "1523",
  	"Food & Grocery Retailers" -> "121",
  	"Bakeries" -> "1573",
  	"Butchers" -> "1574",
  	"Convenience Stores" -> "1575",
  	"Delicatessens" -> "1576",
  	"Farmers' Markets" -> "1577",
  	"Restaurants" -> "276",
  	"Catering" -> "1524",
  	"Dining Guides" -> "917",
  	"Fast Food" -> "918",
  	...
  	"Business & Tycoon Games" -> "1497",
  	"City Building Games" -> "1496",
  	"Life Simulation Games" -> "1498",
  	"Vehicle Simulators" -> "1495",
  	"Sports Games" -> "932",
  	"Sports Management Games" -> "1499",
  	"Strategy Games" -> "933",
  	"Video Game Development" -> "1491",
  	"Video Game Emulation" -> "1342",
  	"Video Game Retailers" -> "1146",
  	"Dice Games" -> "1492",
  	"Educational Games" -> "1493",
  	"Family-Oriented Games & Activities" -> "1290",
  	"Drawing & Coloring" -> "1397",
  	"Dress-Up & Fashion Games" -> "1173",
  	"Gambling" -> "637",
  	"Horse & Dog Racing" -> "698",
  	...
  	"Kosher Foods" -> "1572",
  	"Low Carbohydrate Diets" -> "1570",
  	"Low Fat & Low Cholesterol Diets" -> "1571",
  	...
  	"Vision Care" -> "246",
  	"Eye Exams & Optometry" -> "1502",
  	"Eyeglasses & Contacts" -> "1224",
  	"Laser Vision Correction" -> "1503",
  	"Women's Health" -> "648",
  	"Hobbies & Leisure" -> "65",
  	"Clubs & Organizations" -> "189",
  	"Fraternal Orders & Service Clubs" -> "1468",
  	"Youth Organizations & Resources" -> "1469",
  	"Contests, Awards & Prizes" -> "1276",
  	"Crafts" -> "284",
  	"Ceramics & Pottery" -> "1470",
  	...
  	"Dishwashers" -> "1600",
  	"Kitchen Hoods & Vents" -> "1604",
  	"Microwaves" -> "1601",
  	"Ranges, Cooktops & Ovens" -> "1602",
  	"Refrigerators & Freezers" -> "1603",
  	"Small Kitchen Appliances" -> "1292",
  	"Blenders" -> "1605",
  	"Bread Makers" -> "1606",
  	"Coffee & Espresso Makers" -> "1607",
  	"Food Processors" -> "1608",
  	"Toasters & Toaster Ovens" -> "1609",
  	"Laundry" -> "1364",
  	...
  	"Fraternities, Sororities & Student Societies" -> "1465",
  	...
  	"Lesson Plans" -> "1466",
  	"School Supplies & Classroom Equipment" -> "1467",
  	...
  	"Job Listings" -> "960",
  	"Accounting & Finance Jobs" -> "1472",
  	"Clerical & Administrative Jobs" -> "1473",
  	"Education Jobs" -> "1474",
  	"Executive & Management Jobs" -> "1475",
  	"Government & Public Sector Jobs" -> "1476",
  	"Health & Medical Jobs" -> "1477",
  	"IT & Technical Jobs" -> "802",
  	"Legal Jobs" -> "1478",
  	"Retail Jobs" -> "1479",
  	"Sales & Marketing Jobs" -> "1481",
  	"Temporary & Seasonal Jobs" -> "1480",
  	...
  	"Feed Aggregation & Social Bookmarking" -> "1482",
  	...
  	"Baby & Toddler Toys" -> "1585",
  	"Baby Care & Hygiene" -> "115",
  	"Baby Food & Formula" -> "1584",
  	"Child Care" -> "403",
  	...
  	"Ethics" -> "1483",
  	"Green Living & Environmental Issues" -> "82",
  	...
  	"Bank-Owned & Foreclosed Properties" -> "1460",
  	...
  	"Action Figures" -> "1580",
  	"Building Toys" -> "1581",
  	"Die-cast & Toy Vehicles" -> "1587",
  	"Dolls & Accessories" -> "1582",
  	"Outdoor Toys & Play Equipment" -> "1588",
  	"Puppets" -> "1589",
  	"Ride-On Toys & Wagons" -> "1586",
  	"Stuffed Toys" -> "1583",
  	...
  	"Motor Sports" -> "180",
  	"Auto Racing" -> "1595",
  	"Motorcycle Racing" -> "1596",
  	"Sport Scores & Statistics" -> "1599",
  	"Sporting Goods" -> "263",
  	"American Football Equipment" -> "1611",
  	"Baseball Equipment" -> "1612",
  	"Basketball Equipment" -> "1613",
  	"Bowling Equipment" -> "1615",
  	"Combat Sports Equipment" -> "1616",
  	"Boxing Gloves & Gear" -> "1633",
  	"Martial Arts Equipment" -> "1634",
  	"Cricket Equipment" -> "1617",
  	"Equestrian Equipment & Tack" -> "1618",
  	"Golf Equipment" -> "1619",
  	"Gymnastics Equipment" -> "1620",
  	"Hockey Equipment" -> "1621",
  	"Ice Skating Equipment" -> "1622",
  	"Roller Skating & Rollerblading Equipment" -> "1623",
  	"Skateboarding Equipment" -> "1624",
  	"Soccer Equipment" -> "1614",
  	"Sports Memorabilia" -> "1083",
  	"Squash & Racquetball Equipment" -> "1625",
  	"Table Tennis Equipment" -> "1627",
  	"Tennis Equipment" -> "1628",
  	"Volleyball Equipment" -> "1629",
  	"Water Sports Equipment" -> "1626",
  	"Winter Sports Equipment" -> "1630",
  	"Skiing Equipment" -> "1635",
  	"Snowboarding Gear" -> "1636",
  	"Sports Coaching & Training" -> "1082",
  	"Team Sports" -> "1001",
  	"American Football" -> "258",
  	"Australian Football" -> "1508",
  	"Baseball" -> "259",
  	"Basketball" -> "264",
  	"Cheerleading" -> "534",
  	"Cricket" -> "296",
  	...
  	"Carpooling & Vehicle Sharing" -> "1339",
  	...
  	"Incheon" -> "5370",
  	"Jeju" -> "5371",
  	"North Chungcheong" -> "5678",
  	"North Gyeongsang" -> "5674",
  	"Daegu" -> "5055",
  	"North Jeolla" -> "5676",
  	"Seoul" -> "5057",
  	"South Chungcheong" -> "5677",
  	"Daejeon" -> "5374",
  	"South Gyeongsang" -> "5673",
  	"Busan" -> "5372",
  	"Ulsan" -> "5376",
  	"South Jeolla" -> "5675",
  	"Gwangju" -> "5373",
  	...
  	"Azerbaijan" -> "5538",
  	"Georgia" -> "5539",
  	"Russian Federation" -> "5120",
  	"Far Eastern Russia" -> "5606",
  	"North Caucasian District" -> "5766",
  	"Northwestern Russia" -> "5594",
  	"Saint Petersburg" -> "5122",
  	"Russian Central District" -> "5595",
  	"Moscow" -> "5121",
  	"Russian Southern District" -> "5603",
  	"Siberian Federal District" -> "5605",
  	"Urals District" -> "5607",
  	"Volga District" -> "5604",
  	"South Asia" -> "5074",
  	"Afghanistan" -> "5075",
  	...
  	"Chiang Mai" -> "5810",
  	"Pattaya" -> "5812",
  	"Southern Thailand" -> "5811",
  	"Phuket" -> "5362",
  	"Viet Nam" -> "5071",
  	"Hanoi" -> "5072",
  	"Ho Chi Minh City" -> "5073",
  	"West Asia" -> "5090",
  	"Bahrain" -> "5552",
  	"Iran" -> "5084",
  	"Iraq" -> "5092",
  	...
  	"Bodrum" -> "5849",
  	"Pamukkale" -> "5846",
  	"Black Sea Turkey" -> "5835",
  	"Central Anatolia" -> "5836",
  	"Ankara" -> "5101",
  	"Cappadocia" -> "5844",
  	"Konya" -> "5847",
  	"Eastern Anatolia" -> "5837",
  	"Marmara Region" -> "5838",
  	"Bursa" -> "5841",
  	"Istanbul" -> "5102",
  	"Mediterranean Turkey" -> "5839",
  	"Adana" -> "5848",
  	"Antalya" -> "5843",
  	"Mersin" -> "5850",
  	"Southeastern Anatolia" -> "5840",
  	"United Arab Emirates" -> "5103",
  	"Yemen" -> "5581",
  	"Europe" -> "5104",
  	"Central & Eastern Europe" -> "5565",
  	"Austria" -> "5178",
  	"Vienna" -> "5179",
  	"Baltics" -> "5556",
  	"Estonia" -> "5128",
  	...
  	"Frankfurt" -> "5193",
  	"Lower Saxony" -> "5492",
  	"Mecklenburg-Vorpommern" -> "5496",
  	"North Rhine-Westphalia" -> "5489",
  	"Cologne" -> "5190",
  	"Duesseldorf" -> "5191",
  	"Essen (Ruhr Area)" -> "5192",
  	"Rhineland-Palatinate" -> "5497",
  	"Saarland" -> "5498",
  	"Saxony" -> "5499",
  	"Saxony-Anhalt" -> "5500",
  	"Schleswig-Holstein" -> "5501",
  	"Thuringia" -> "5502",
  	"Hungary" -> "5110",
  	"Budapest" -> "5111",
  	"Liechtenstein" -> "5566",
  	"Poland" -> "5112",
  	"Katowice (Upper Silesian)" -> "5113",
  	"Krakow" -> "5114",
  	"Warsaw" -> "5115",
  	"Wroclaw" -> "5116",
  	"Łódź" -> "5117",
  	...
  	"Campania" -> "5504",
  	"Naples" -> "5160",
  	"Salerno & Amalfi Coast" -> "5771",
  	"Emilia-Romagna" -> "5508",
  	"Friuli-Venezia Giulia" -> "5717",
  	"Lazio" -> "5505",
  	"Rome" -> "5162",
  	"Liguria" -> "5511",
  	"Genoa" -> "5158",
  	...
  	"Aragon" -> "5485",
  	"Asturias" -> "5487",
  	"Balearic Islands" -> "5488",
  	"Basque Country" -> "5481",
  	"Canary Islands" -> "5482",
  	"Cantabria" -> "5770",
  	"Castile and León" -> "5480",
  	"Castile-La Mancha" -> "5483",
  	"Catalonia" -> "5477",
  	"Barcelona" -> "5172",
  	"Extremadura" -> "5486",
  	"Galicia" -> "5479",
  	"Madrid" -> "5173",
  	"Murcia" -> "5484",
  	"Valencian Community" -> "5478",
  	"Valencia" -> "5176",
  	"Vatican City" -> "5769",
  	"Nordic Countries" -> "5125",
  	"Denmark" -> "5126",
  	"Copenhagen" -> "5127",
  	"Finland" -> "5129",
  	"Helsinki" -> "5130",
  	...
  	"Sweden" -> "5138",
  	"Stockholm" -> "5139",
  	"Southeastern Europe" -> "5567",
  	"Albania" -> "5582",
  	"Bosnia and Herzegovina" -> "5151",
  	"Bulgaria" -> "5107",
  	"Croatia" -> "5152",
  	"Greece" -> "5153",
  	"Aegean Islands" -> "5831",
  	...
  	"Strasbourg" -> "5610",
  	"Burgundy" -> "5684",
  	"Champagne-Ardenne" -> "5685",
  	"Franche-Comté" -> "5686",
  	"Lorraine" -> "5687",
  	"French Overseas (DOM-TOM)" -> "5608",
  	"North France" -> "5532",
  	"Lower Normandy" -> "5688",
  	"Nord-Pas-de-Calais" -> "5690",
  	"Lille" -> "5611",
  	"Picardy" -> "5691",
  	"Upper Normandy" -> "5689",
  	"South East France" -> "5528",
  	"Corsica" -> "5617",
  	"Provence-Alpes-Côte d'Azur" -> "5692",
  	"Marseille" -> "5184",
  	"Nice" -> "5185",
  	"Rhône-Alpes" -> "5693",
  	"Lyon" -> "5183",
  	"South West France" -> "5527",
  	"Aquitaine" -> "5694",
  	"Bordeaux" -> "5613",
  	"Languedoc-Roussillon" -> "5695",
  	"Montpellier" -> "5612",
  	"Midi-Pyrénées" -> "5696",
  	"Toulouse" -> "5187",
  	"West France" -> "5530",
  	"Brittany" -> "5697",
  	"Rennes" -> "5614",
  	"Pays de la Loire" -> "5698",
  	"Nantes" -> "5609",
  	"Poitou-Charentes" -> "5699",
  	"Île - de - France" -> "5529",
  	"Paris" -> "5186",
  	"Ireland" -> "5132",
  	"Dublin" -> "5133",
  	...
  	"England" -> "5440",
  	"East Midlands" -> "5447",
  	"East of England" -> "5446",
  	"London (UK)" -> "5147",
  	"North East England" -> "5451",
  	"North West England" -> "5450",
  	"Liverpool" -> "5146",
  	"Manchester" -> "5148",
  	"South East England" -> "5444",
  	"South West England" -> "5445",
  	"Bristol" -> "5142",
  	"West Midlands" -> "5448",
  	"Birmingham (UK)" -> "5141",
  	"Yorkshire" -> "5449",
  	...
  	"Latin America" -> "5203",
  	"Caribbean" -> "5204",
  	"Antigua & Barbuda" -> "5550",
  	"Aruba, Bonaire & Curaçao" -> "5569",
  	"Bahamas" -> "5360",
  	"Barbados" -> "5559",
  	"Cayman Islands" -> "5570",
  	"Cuba" -> "5205",
  	"Dominica" -> "5560",
  	"Dominican Republic" -> "5206",
  	"Grenada" -> "5561",
  	"Guadeloupe" -> "5700",
  	"Haiti" -> "5562",
  	"Jamaica" -> "5439",
  	"Martinique" -> "5701",
  	"Puerto Rico" -> "5207",
  	"Saint Kitts & Nevis" -> "5563",
  	"Saint Lucia" -> "5564",
  	"Saint Vincent & Grenadines" -> "5572",
  	"Trinidad & Tobago" -> "5573",
  	"Virgin Islands" -> "5571",
  	"Central America" -> "5208",
  	"Belize" -> "5549",
  	"Costa Rica" -> "5209",
  	"El Salvador" -> "5548",
  	"Guatemala" -> "5547",
  	"Honduras" -> "5546",
  	"Mexico" -> "5210",
  	"Baja California" -> "5792",
  	"Los Cabos" -> "5813",
  	"Tijuana" -> "5214",
  	"Central Mexico" -> "5797",
  	"Cuernavaca (Morelos)" -> "5814",
  	"Guanajuato" -> "5801",
  	"Mexico City" -> "5212",
  	"Mexico State" -> "5798",
  	"Puebla" -> "5800",
  	"Veracruz" -> "5799",
  	"Northern Mexico" -> "5793",
  	"Chihuahua" -> "5795",
  	"Nuevo León" -> "5794",
  	"Monterrey" -> "5213",
  	"Tamaulipas" -> "5796",
  	"Pacific Coast (Mexico)" -> "5802",
  	"Chiapas" -> "5806",
  	"Guerrero" -> "5803",
  	"Acapulco" -> "5815",
  	"Jalisco" -> "5805",
  	"Guadalajara" -> "5211",
  	"Puerto Vallarta" -> "5816",
  	"Michoacán" -> "5807",
  	"Oaxaca" -> "5804",
  	"Sinaloa" -> "5808",
  	"Yucatán Peninsula" -> "5809",
  	"Quintana Roo" -> "5817",
  	"Cancún & Riviera Maya" -> "5819",
  	"Yucatán" -> "5818",
  	"Mérida" -> "5820",
  	"Nicaragua" -> "5545",
  	"Panama" -> "5215",
  	...
  	"Bolivia" -> "5540",
  	"Brazil" -> "5219",
  	"Central West Brazil" -> "5526",
  	"Brasilia" -> "5221",
  	"Goiás" -> "5774",
  	"Mato Grosso" -> "5786",
  	"Mato Grosso do Sul" -> "5787",
  	"North Brazil" -> "5522",
  	"Amazonas" -> "5788",
  	"Pará" -> "5789",
  	"Rondônia" -> "5790",
  	"Tocantins" -> "5791",
  	"Northeast Brazil" -> "5523",
  	"Alagoas" -> "5778",
  	"Bahia" -> "5631",
  	"Salvador" -> "5226",
  	"Ceará" -> "5779",
  	...
  	"Recife" -> "5224",
  	"Piauí" -> "5783",
  	"Rio Grande do Norte" -> "5784",
  	"Sergipe" -> "5785",
  	"South Brazil" -> "5524",
  	"Paraná" -> "5627",
  	"Rio Grande do Sul" -> "5630",
  	"Porto Alegre" -> "5223",
  	"Santa Catarina" -> "5629",
  	"Southeast Brazil" -> "5525",
  	"Espirito Santo" -> "5777",
  	"Minas Gerais" -> "5632",
  	"Belo Horizonte" -> "5220",
  	"Rio de Janeiro" -> "5225",
  	...
  	"Bermuda" -> "5354",
  	"Canada" -> "5238",
  	"Atlantic Provinces" -> "5239",
  	"New Brunswick" -> "5596",
  	"Newfoundland & Labrador" -> "5598",
  	"Nova Scotia" -> "5597",
  	"Halifax" -> "5240",
  	"Prince Edward Island" -> "5599",
  	"British Columbia" -> "5241",
  	"Vancouver" -> "5242",
  	"Victoria (BC)" -> "5243",
  	"Canadian Prairies" -> "5244",
  	"Alberta" -> "5600",
  	"Calgary" -> "5245",
  	"Edmonton" -> "5246",
  	"Manitoba" -> "5602",
  	"Winnipeg" -> "5247",
  	"Saskatchewan" -> "5601",
  	"Northern Territories" -> "5248",
  	"Ontario" -> "5249",
  	"Greater Toronto" -> "5253",
  	"Hamilton-Niagara Peninsula" -> "5250",
  	"Ottawa-Gatineau" -> "5252",
  	"Southwestern Ontario" -> "5251",
  	"Quebec" -> "5254",
  	"Montreal" -> "5255",
  	"Quebec City" -> "5256",
  	"USA" -> "5257",
  	"Alaska" -> "5258",
  	"California" -> "5259",
  	"California Central Coast" -> "5669",
  	"Lake Tahoe" -> "5474",
  	"Sacramento Valley" -> "5263",
  	"San Francisco Bay Area" -> "5265",
  	"San Joaquin Valley" -> "5260",
  	"Silicon Valley" -> "5266",
  	"Southern California" -> "5535",
  	"Inland Empire" -> "5262",
  	"Los Angeles" -> "5261",
  	"Orange County (CA)" -> "5475",
  	"San Diego" -> "5264",
  	"Florida" -> "5267",
  	"Central Florida" -> "5624",
  	"Deltona-Daytona Beach" -> "5642",
  	"Greater Orlando" -> "5270",
  	"Tampa Bay Area" -> "5271",
  	"Florida Panhandle" -> "5622",
  	"Tallahassee" -> "5824",
  	"North Florida" -> "5623",
  	"Jacksonville" -> "5268",
  	"Southern Florida" -> "5638",
  	"Florida Keys" -> "5822",
  	"Fort Myers-Cape Coral" -> "5823",
  	"South Florida Metro" -> "5625",
  	"Broward-Fort Lauderdale" -> "5641",
  	"Miami-Dade" -> "5269",
  	"West Palm Beach-Boca Raton" -> "5272",
  	"Great Plains (USA)" -> "5273",
  	"Kansas" -> "5462",
  	"Nebraska" -> "5470",
  	"North Dakota" -> "5471",
  	"Oklahoma" -> "5426",
  	...
  	"South Dakota" -> "5472",
  	"Hawaii" -> "5276",
  	"Big Island (Hawaii)" -> "5828",
  	"Kauai" -> "5829",
  	"Maui" -> "5827",
  	"Oahu" -> "5826",
  	"Mid-Atlantic (USA)" -> "5277",
  	"Delaware" -> "5463",
  	"Maryland" -> "5427",
  	"Baltimore Metro" -> "5279",
  	"New Jersey" -> "5411",
  	"New York State" -> "5409",
  	"Albany-Capital District" -> "5278",
  	"Buffalo-Niagara Falls" -> "5280",
  	"New York City" -> "5282",
  	"Rochester-Finger Lakes" -> "5285",
  	"Pennsylvania" -> "5410",
  	"Harrisburg-South Central PA" -> "5281",
  	"Philadelphia" -> "5283",
  	"Pittsburgh" -> "5284",
  	"Washington DC" -> "5286",
  	"Midwest (USA)" -> "5287",
  	...
  	"Michigan" -> "5413",
  	"Detroit" -> "5292",
  	"Grand Rapids-West Michigan" -> "5293",
  	"Minnesota" -> "5431",
  	"Minneapolis-Saint Paul" -> "5297",
  	"Missouri" -> "5414",
  	"Greater St. Louis" -> "5298",
  	"Kansas City" -> "5295",
  	"Ohio" -> "5412",
  	"Cincinnati" -> "5289",
  	"Columbus (OH)" -> "5291",
  	"Greater Cleveland" -> "5290",
  	"Wisconsin" -> "5430",
  	"Milwaukee" -> "5296",
  	"New England" -> "5299",
  	"Connecticut" -> "5423",
  	"Greater Hartford" -> "5301",
  	"New Haven" -> "5670",
  	"Maine" -> "5459",
  	"Massachusetts" -> "5424",
  	"Boston Metro" -> "5300",
  	...
  	"Providence" -> "5302",
  	"Vermont" -> "5460",
  	"Pacific Northwest" -> "5303",
  	"Oregon" -> "5433",
  	"Portland (OR)" -> "5304",
  	"Washington State" -> "5432",
  	"Seattle-Tacoma" -> "5305",
  	"Rocky Mountains" -> "5306",
  	"Colorado" -> "5434",
  	"Denver" -> "5307",
  	"Idaho" -> "5466",
  	"Montana" -> "5465",
  	...
  	"Mississippi" -> "5469",
  	"North Carolina" -> "5416",
  	"Charlotte Metro" -> "5312",
  	"Piedmont Triad" -> "5313",
  	"Raleigh-Durham" -> "5320",
  	"South Carolina" -> "5418",
  	"Greater Charleston (SC)" -> "5618",
  	"Myrtle Beach & Grand Strand" -> "5821",
  	"Upstate South Carolina" -> "5314",
  	"Tennessee" -> "5419",
  	"Memphis" -> "5316",
  	"Nashville" -> "5317",
  	"Virginia" -> "5415",
  	"Richmond-Petersburg" -> "5321",
  	"Virginia Beach-Hampton Roads" -> "5319",
  	"West Virginia" -> "5468",
  	"Southwest (USA)" -> "5322",
  	"Arizona" -> "5435",
  	"Phoenix" -> "5325",
  	...
  	"Reno-Sparks" -> "5326",
  	"New Mexico" -> "5438",
  	"Albuquerque-Santa Fe" -> "5323",
  	"Utah" -> "5437",
  	"Salt Lake City" -> "5327",
  	"Texas" -> "5329",
  	"Austin-Round Rock" -> "5330",
  	"Dallas-Fort Worth" -> "5331",
  	"El Paso" -> "5332",
  	"Houston" -> "5333",
  	"San Antonio" -> "5334",
  	"Oceania" -> "5335",
  	"Australia" -> "5336",
  	"New South Wales" -> "5452",
  	"Canberra" -> "5339",
  	"Newcastle (AU)" -> "5342",
  	"Sydney" -> "5344",
  	"Northern Territory" -> "5457",
  	"Queensland" -> "5453",
  	"Brisbane" -> "5338",
  	"Cairns" -> "5357",
  	"Gold Coast" -> "5340",
  	"South Australia" -> "5456",
  	"Adelaide" -> "5337",
  	"Tasmania" -> "5356",
  	"Victoria (AU)" -> "5454",
  	"Melbourne" -> "5341",
  	"Western Australia" -> "5455",
  	"Perth" -> "5343",
  	"New Zealand" -> "5350",
  	"Auckland" -> "5351",
  	"Christchurch" -> "5359",
  	"Wellington" -> "5358",
  	"Pacific Islands" -> "5589",
  	"Melanesia" -> "5345",
  	"Fiji" -> "5346",
  	"Papua New Guinea" -> "5347",
  	"Micronesia" -> "5348",
  	"Guam" -> "5349",
  	"Polynesia" -> "5352",
  	"Tahiti & Bora Bora" -> "5568",
  	"Polar Regions" -> "5353")


  def getInterestId(interest:String):Long = {
    verticals.getOrElse(interest, "0").toLong
  }
}
